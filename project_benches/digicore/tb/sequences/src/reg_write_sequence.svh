...
class reg_write_sequence extends digicore_bench_sequence_base;

  `uvm_object_utils( reg_write_sequence );

  uvm_reg_mem_built_in_seq uvm_reg_write_seq;
  ...
  // ****************************************************************************
  virtual task body();
    uvm_reg_write_seq = new("uvm_reg_write_seq");
