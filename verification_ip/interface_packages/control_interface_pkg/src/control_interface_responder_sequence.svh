...
//----------------------------------------------------------------------
//
class control_interface_responder_sequence #(
...
;
  ...
  `uvm_object_param_utils( control_interface_responder_sequence #(
                           DVDD_STARTUP_TIME,
                           PORZ_STARTUP_TIME,
  ...
  function new(string name = "control_interface_responder_sequence");
    super.new(name);
  endfunction
